 ...
 *
 */
class LogicalKernelWindow: public LogicalOperator
{
public:

    LogicalKernelWindow(const std::string& logicalName, const std::string& alias):
...
DECLARE_LOGICAL_OPERATOR_FACTORY(LogicalKernelWindow, "kernelwindow")
