...
class PhysicalKernelWindow: public  PhysicalOperator
{
private:
...
public:
    ...
    PhysicalKernelWindow(const string& logicalName, const string& physicalName,
...
DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalKernelWindow, "kernelwindow", "PhysicalKernelWindow")
