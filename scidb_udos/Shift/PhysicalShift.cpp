...
public:
     ...
     * variables.
     */
    PhysicalShift(string const& logicalName,
    ...
    std::shared_ptr< Array> execute(vector< std::shared_ptr< Array> >& inputArrays, std::shared_ptr<Query> query)
    {
    	...
    	/*
    	 * TODO: Isolate the array dimensions which will allow for the array shift
    	 * TODO: Construct the output array which has the same schema as the input array
    	 * TODO: Iterate over the Array and Chunks and shift the values by the shift value across the selected dimension.
    	 *
    	 */
