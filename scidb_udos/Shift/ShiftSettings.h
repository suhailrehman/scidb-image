...
#ifndef SHIFT_SHIFTSETTINGS_H_
#define SHIFT_SHIFTSETTINGS_H_
...
public:
    ...
    ShiftSettings(vector<shared_ptr<OperatorParam> > const& operatorParameters,
                 bool logical,
