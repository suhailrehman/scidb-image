...
time iquery -vnq "SELECT * INTO temp_average FROM average_img JOIN weights ON average_img.i3 = weights.i0;"
...
time iquery -vnaq "store(project(apply(average_image,weighted_image_avg, weighted_image_sum / $WEIGHTTOTAL ),weighted_image_avg),average_image2)"
